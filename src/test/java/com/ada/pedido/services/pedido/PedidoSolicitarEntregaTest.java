...
class PedidoSolicitarEntregaTest {

    private final PedidoSolicitarEntrega pedidoSolicitarEntrega = new PedidoSolicitarEntrega();
    ...
    void processar_deveExecutarSemErroQuandoPedidoProcessado() {
        ...
        pedidoSolicitarEntrega.processar(pedido);
